          ...
          <Box sx={{ mt: 2 }}>
            ...
            <FormControl fullWidth margin="normal">
              ...
              <Select
                ...
                label={t('risks.status', 'Status')}
              >
                <MenuItem value={IssueStatus.OPEN}>{t('riskStatus.OPEN')}</MenuItem>
                <MenuItem value={IssueStatus.IN_PROGRESS}>{t('riskStatus.IN_PROGRESS')}</MenuItem>
                <MenuItem value={IssueStatus.RESOLVED}>{t('riskStatus.RESOLVED')}</MenuItem>
                <MenuItem value={IssueStatus.CLOSED}>{t('riskStatus.CLOSED')}</MenuItem>
              </Select>
            </FormControl>
            ...
            <FormControl fullWidth margin="normal">
              ...
              <Select
                ...
                label={t('risks.impact', 'Impact')}
              >
                <MenuItem value={RiskImpact.LOW}>{t('riskImpact.LOW')}</MenuItem>
                <MenuItem value={RiskImpact.MEDIUM}>{t('riskImpact.MEDIUM')}</MenuItem>
                <MenuItem value={RiskImpact.HIGH}>{t('riskImpact.HIGH')}</MenuItem>
                <MenuItem value={RiskImpact.CRITICAL}>{t('riskImpact.CRITICAL')}</MenuItem>
              </Select>
            </FormControl>
