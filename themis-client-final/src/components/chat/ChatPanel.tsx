...
import { Box, Typography, Divider, CircularProgress, Paper, IconButton, Toolbar, Badge, Tooltip } from '@mui/material';
...
import { ChatChannel, ChatMessage, ChannelType } from '../../types/ChatTypes';
