...
const RiskIssueRegister: React.FC<RiskIssueRegisterProps> = ({ project }) => {
  ...
  const handleSaveRisk = async () => {
    ...
    try {
      if (editingRisk) {
        ...
        // Update local state
        setRisks(prev => [...prev, newRisk as Risk]);
  ...
  const handleSaveIssue = async () => {
    ...
    try {
      if (editingIssue) {
        ...
        // Update local state
        setIssues(prev => [...prev, newIssue as Issue]);
  ...
  const handleExportRisks = () => {
    ...
    exportToExcel(data, `${project.name}_Risks_Register`, 'Risks');
  };
  ...
  const handleExportIssues = () => {
    ...
    exportToExcel(data, `${project.name}_Issues_Register`, 'Issues');
  };
